...
\item[Comment] While other values are allowed, the following semantics
                     	...
                     	the column may contain null or empty values; generated
                     	– values in this column are generated during
                     	output and query constraints cannot be used.
\end{description}
...
\begin{itemize}
\item ``generated'' is a new TableParam flag to indicate columns with
